...
import signUp from '../../../../assets/images/icons/add (1).png'
...
const SignUp = () => {
    const { user, loader, setLoader, createUser, userProfile, SignIn } = useContext(AuthContext)
    ...
    const { register, handleSubmit, reset, watch, formState, formState: { errors, isSubmitting } } = useForm();
    ...
    const handleFacebookSignIn = () => {
        SignIn(facebookProvider)
            ...
            .catch(e => {
                setError({ ...error, facebookError: e.message })
            })
    }
    return (
        <div className='w-100 bgImg relative'>
            <div className='w-full lg:w-1/2 absolute lg:left-72 lg:top-5 border-2 rounded-md shadow-2xl shadow-black bg-base-300'>
                <div className='flex flex-col items-center justify-evenly my-5'>
                    ...
                    <img src={signUp} className="w-8 lg:w-12" alt="" />
                </div>
                <div className=''>
